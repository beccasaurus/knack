...
namespace Owin {
    ...
    public class Response : IResponse {
        ...
        public Response(string bodyText, string status)
            : this(bodyText) {
            Status = status;
        }

        public Response(string bodyText)
            : this() {
            BodyText = bodyText;
        }

        public Response(string bodyText, int statusCode)
            : this() {
            BodyText = bodyText;
        ...
        public Response(int statusCode, string bodyText, IDictionary<string, string> headers)
            : this() {
        ...
        public Response(int statusCode, string bodyText, IDictionary<string, IEnumerable<string>> headers)
            : this() {
            if (statusCode != 0) SetStatus(statusCode);
            if (bodyText != null) BodyText = bodyText;
            if (headers != null) AddHeaders(headers);
