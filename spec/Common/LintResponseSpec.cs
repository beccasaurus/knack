...
namespace Owin.Common.Specs {
	...
	public class LintResponseSpec {
		...
		[Test]
		[Ignore]
		public void GetBody_must_be_UTF8_or_raw_or_FileInfo() { } // TODO later

		[Test]
		[Ignore]
		public void Headers_requires_content_type() { } // <--- not part of the spec but should be! ... enable a Strict mode for these?  or fork?
